...
it('generates summary for previous conversation cycle', function () {
    Embeddings::fake();
    AnonymousAgent::fake(['Weekly summary generated by Morgan.']);
    ...
    expect($summary)
        ...
        ->summary->toBe('Weekly summary generated by Morgan.')
        ->stats->toBeArray();
    ...
    $this->assertDatabaseHas('user_conversation_summaries', [
        ...
        'summary' => 'Weekly summary generated by Morgan.',
    ]);

    $this->assertDatabaseHas('chat_messages', [
        'user_id' => $this->user->id,
        'role' => 'assistant',
        'content' => 'Weekly summary generated by Morgan.',
    ]);
...
it('returns null when previous conversation cycle has no meals', function () {
    Carbon::setTestNow(Carbon::parse('2026-06-10 10:00:00'));
