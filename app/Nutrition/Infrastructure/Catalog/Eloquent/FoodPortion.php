...
#[UseFactory(FoodPortionFactory::class)]
class FoodPortion extends Model
{
    /** @use HasFactory<FoodPortionFactory> */
    use HasFactory;
    ...
    {
        return $this->belongsTo(self::class, 'supersedes_food_portion_id');
    }

    public function supersededBy(): HasOne
    {
        return $this->hasOne(self::class, 'supersedes_food_portion_id');
    }
